    ...
    >
      {({ getRootProps, acceptedFiles }) => (
        <motion.div
          ...
          key="@uploadDropzone"
          className="m-4 h-[300px] rounded-lg border border-dashed border-gray-300 dark:border-gray-700"
        >
          <div
                ...
                <div className="mx-auto mt-4 w-full max-w-xs">
                  ...
                  {uploadProgress === 100 && (
                    <div className="flex items-center justify-center gap-1 p-2 text-center text-sm text-zinc-700">
                      <LoadingSpinner className="size-3" /> Redirecting...
                    </div>
                  )}
                </div>
              )}
...
export const UploadModal = () => {
  ...
  return (
    <ModalResponsive
      ...
      contentDialogProps={{ className: "max-w-3xl h-[400px]" }}
